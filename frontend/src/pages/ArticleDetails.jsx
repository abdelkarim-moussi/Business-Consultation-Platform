      ...
      <main className="grid grid-cols-1 md:grid-cols-3 gap-10 p-6 max-w-6xl mx-auto mt-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <article className="prose max-w-none prose-lg prose-blue">
            <p>
              In today’s competitive market, growing a business isn’t just about
              having a good product. It's about understanding your audience,
              streamlining operations, and leveraging expert advice when
              necessary.
            </p>
            <p>
          ...
          <div className="bg-[#f4f8f9] p-4 rounded-2xl shadow-md">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Self Development Coach</p>
              </div>
            </div>
          </div>
